 var cityData = {
    ...
    "650000": [
        ...
        {code:"654300",name:"阿勒泰地区"}
            ...
            {code:'710300',name:'基隆市'},
            {code:'710400',name:'台中市'},
            {code:'710500',name:'台南市'},
            {code:'710600',name:'新竹市'},
            {code:'710700',name:'嘉义市'},
            {code:'710800',name:'台北县(板桥市)'},
            {code:'710900',name:'宜兰县(宜兰市)'},
            {code:'711000',name:'新竹县(竹北市)'},
            {code:'711100',name:'桃园县(桃园市)'},
            {code:'711200',name:'苗栗县(苗栗市)'},
            {code:'711300',name:'台中县(丰原市)'},
            {code:'711400',name:'彰化县(彰化市)'},
            {code:'711500',name:'南投县(南投市)'},
            {code:'711600',name:'嘉义县(太保市)'},
            {code:'711700',name:'云林县(斗六市)'},
            {code:'711800',name:'台南县(新营市)'},
            {code:'711900',name:'高雄县(凤山市)'},
            {code:'712000',name:'屏东县(屏东市)'},
            {code:'712100',name:'台东县(台东市)'},
            {code:'712200',name:'花莲县(花莲市)'},
            {code:'712300',name:'澎湖县(马公市)'}
        ],
	'810000':[{code:'810100',name:'香港特别行政区市辖区'}
	],
	'820000':[{code:'820100',name:'澳门特别行政区'}
	]
 };
 ...
 var areData = {
	...
	"441900":[
        {code:"441900",name:"东莞市辖区"}
    ],
	"442000":[
        {code:"442000",name:"中山市辖区"}
    ],
    "445100": [
	...
	'500000':[{code:'500101',name:'万州区'},
		...
		{code:'500110',name:'綦江县'},
		{code:'500111',name:'大足县'},
		{code:'500112',name:'渝北区'},
        {code:'500113',name:'巴南区'},
        {code:'500114',name:'黔江区'},
		{code:'500115',name:'长寿区'},
		{code:'500116',name:'江津市'},
        {code:'500117',name:'合川市'},
        {code:'500118',name:'永川市'},
        {code:'500119',name:'南川市'},
        {code:'500120',name:'璧山县'},
        {code:'500151',name:'铜梁县'},
		{code:'500152',name:'潼南县'},
		{code:'500153',name:'荣昌县'},
	...
	'710300':[{code:'710301',name:'仁爱区'},
        {code:'710302',name:'信义区'},
        {code:'710303',name:'中正区'},
        {code:'710304',name:'中山区'},
        {code:'710305',name:'安乐区'},
        {code:'710306',name:'暖暖区'},
        {code:'710307',name:'七堵区'}
    ], 
    '710400':[{code:'710401',name:'中区'},
        {code:'710402',name:'东区'},
        {code:'710403',name:'南区'},
        {code:'710404',name:'西区'},
        {code:'710405',name:'北区'},
    ...
    '710600':[{code:'710601',name:'东区'},
        {code:'710602',name:'北区'},
        {code:'710603',name:'香山区'}
    ],
    '710700':[{code:'710701',name:'东区'},
        {code:'710702',name:'西区'}
    ],
    '710800':[{code:'710801',name:'台北县(板桥市)'}
    ],
    '710900':[{code:'710901',name:'宜兰县(宜兰市)'}
    ],
    '711000':[{code:'711001',name:'新竹县(竹北市)'}
    ],
    '711100':[{code:'711101',name:'桃园县(桃园市)'}
    ],
    '711200':[{code:'711201',name:'苗栗县(苗栗市)'}
    ],
    '711300':[{code:'711301',name:'台中县(丰原市)'}
    ],
    '711400':[{code:'711401',name:'彰化县(彰化市)'}
    ],
    '711500':[{code:'711501',name:'南投县(南投市)'}
    ],
    '711600':[{code:'711601',name:'嘉义县(太保市)'}
    ],
    '711700':[{code:'711701',name:'云林县(斗六市)'}
    ],
    '711800':[{code:'711801',name:'台南县(新营市)'}
    ],
    '711900':[{code:'711901',name:'高雄县(凤山市)'}
    ],
    '712000':[{code:'712001',name:'屏东县(屏东市)'}
    ],
    '712100':[{code:'712101',name:'台东县(台东市)'}
    ],
    '712200':[{code:'712201',name:'花莲县(花莲市)'}
    ],
    '712300':[{code:'712301',name:'澎湖县(马公市)'}
    ],
    '810100':[{code:'810101',name:'中西区'},
        {code:'810102',name:'东区'},
        {code:'810103',name:'九龙城区'},
        {code:'810104',name:'观塘区'},
        {code:'810105',name:'南区'},
        {code:'810106',name:'深水埗区'},
        {code:'810107',name:'黄大仙区'},
        {code:'810108',name:'湾仔区'},
        {code:'810109',name:'油尖旺区'},
        {code:'810110',name:'离岛区'},
        {code:'810111',name:'葵青区'},
        {code:'810112',name:'北区'},
        {code:'810113',name:'西贡区'},
        {code:'810114',name:'沙田区'},
        {code:'810115',name:'屯门区'},
        {code:'810116',name:'大埔区'},
        {code:'810117',name:'荃湾区'},
        {code:'810118',name:'元朗区'}
    ],
	'820100':[
